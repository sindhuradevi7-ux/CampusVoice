  ...
  return (
    <div className="max-w-lg mx-auto my-12 px-4">
      <div className="bg-white dark:bg-wine-900 p-6 sm:p-8 rounded-3xl border border-cream-300 dark:border-peach-400/20 shadow-warm-lg transition-colors">
        ...
        {/* Privacy Note */}
        <div className="p-3.5 bg-peach-50 dark:bg-wine-950/80 border border-peach-300 dark:border-peach-400/20 rounded-2xl mb-5 text-xs text-burgundy-950 dark:text-cream-200 flex items-start gap-2.5 shadow-sm">
          <Lock className="w-4 h-4 text-peach-700 dark:text-peach-400 shrink-0 mt-0.5" />
          <span>
            <strong className="font-bold text-burgundy-900 dark:text-peach-300">Privacy Guarantee:</strong> Your Name, Email & Student ID will be isolated from organization views. Admin will only see "Verified Anonymous Student".
          </span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                <User className="w-4 h-4 text-wine-400 dark:text-wine-500 absolute left-3.5 top-1/2 -translate-y-1/2" />
                <input
                  type="text"
                  name="name"
                  value={formData.name}
            ...
            <div>
              ...
              <div className="relative">
                <BadgeAlert className="w-4 h-4 text-wine-400 dark:text-wine-500 absolute left-3.5 top-1/2 -translate-y-1/2" />
                <input
                  type="text"
                  name="studentId"
          ...
          <div>
            ...
            <p className="text-[11px] text-wine-500 dark:text-cream-400 mt-1">
        ...
        <div className="mt-6 pt-5 border-t border-cream-300 dark:border-peach-400/20 text-center">
          <p className="text-xs text-wine-600 dark:text-cream-300">
            ...
            <Link to="/login" className="text-burgundy-800 dark:text-peach-300 hover:underline font-bold">
              Sign In
            </Link>
          </p>
        </div>
